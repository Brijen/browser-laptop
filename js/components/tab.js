...
const {getTabBreakpoint} = require('../../app/renderer/lib/tabUtil')
  ...
  render () {
    ...
    return <div
      ...
      <div className={css(
        ...
        process.platform === 'win32' && styles.tabForWindows
        )}
        ...
        <CloseTabIcon
          tabProps={this.props.tab}
          criteria={!this.isPinned}
          onClick={this.onCloseFrame.bind(this)}
